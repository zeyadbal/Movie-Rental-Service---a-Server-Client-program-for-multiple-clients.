...
public class NonBlockingConnectionHandler<T> implements bgu.spl181.net.srv.bidi.ConnectionHandler<T> {
    ...
    public NonBlockingConnectionHandler(
    		...
    		bgu.spl181.net.api.bidi.BidiMessagingProtocol<T> protocol,
            SocketChannel chan,
            Reactor<T> reactor,
            Connections<T> CurrentConnections,
			Integer id) {
